                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('estado-contratos.destroy',$estadoContrato->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('estado-contratos.show',$estadoContrato->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('estado-contratos.edit',$estadoContrato->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
