                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('puestolaborals.destroy',$puestolaboral->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('puestolaborals.show',$puestolaboral->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('puestolaborals.edit',$puestolaboral->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
