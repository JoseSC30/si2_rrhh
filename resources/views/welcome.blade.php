        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 ligth:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="">
                ...
                <div class="col-auto bg-danger p-5 text-center m-4 row justify-content-center">
                    @auth
                        <a href="{{ url('/home') }}" class="mt-2 text-black-600 dark:text-black-400 text-sm">PAGINA PRINCIPAL</a>
                    @else
                        <a href="{{ route('login') }}" class="mt-4 text-black-900 dark:text-black-400 text-sm" >INICIAR SESIÓN</a>
